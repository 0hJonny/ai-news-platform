...
-- +goose Down
DROP INDEX IF EXISTS chats.idx_feedback_message;
DROP INDEX IF EXISTS chats.idx_messages_session_time;
DROP INDEX IF EXISTS chats.idx_sessions_user_active;
DROP TABLE IF EXISTS chats.feedback;
DROP TABLE IF EXISTS chats.messages;
DROP TABLE IF EXISTS chats.sessions;
DROP TYPE IF EXISTS chats.message_role;
DROP TYPE IF EXISTS chats.feedback_rating;
DROP SCHEMA IF EXISTS chats CASCADE;
